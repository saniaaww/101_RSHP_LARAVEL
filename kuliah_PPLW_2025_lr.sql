...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2025 at 09:14 AM
-- Server version: 10.4.27-MariaDB
-- PHP Version: 8.1.12
CREATE DATABASE kuliah_PPLW_2025_lr;
USE kuliah_PPLW_2025_lr;
...
--
ALTER TABLE `role_user`
  MODIFY `idrole_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
-- Buat tabel temu_dokter
CREATE TABLE temu_dokter (
    idreservasi_dokter INT AUTO_INCREMENT PRIMARY KEY,
    no_urut INT,
    ...
    FOREIGN KEY (idrole_user) REFERENCES role_user(idrole_user)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Tambah kolom idreservasi_dokter ke tabel rekam_medis
ALTER TABLE rekam_medis
    ADD COLUMN idreservasi_dokter INT(11) NULL AFTER dokter_pemeriksa,
    ADD CONSTRAINT fk_rekam_medis_temu_dokter 
