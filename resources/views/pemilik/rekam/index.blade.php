...
<a href="{{ route('pemilik.rekam.create') }}" class="btn btn-primary mb-3">Tambah Rekam Medis</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('pemilik.rekam.edit', $d->idrekam_medis) }}" class="btn btn-sm btn-warning">Edit</a>

                    <form action="{{ route('pemilik.rekam.destroy', $d->idrekam_medis) }}" method="POST" class="d-inline">
                        @csrf @method('DELETE')
