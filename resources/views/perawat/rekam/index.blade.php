...
<a href="{{ route('perawat.rekam.create') }}" class="btn btn-primary mb-3">Tambah Rekam Medis</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('perawat.rekam.edit', $d->idrekam_medis) }}" class="btn btn-sm btn-warning">Edit</a>

                    <form action="{{ route('perawat.rekam.destroy', $d->idrekam_medis) }}" method="POST" class="d-inline">
                        @csrf @method('DELETE')
