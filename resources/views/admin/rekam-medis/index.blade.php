...
<a href="{{ route('admin.rekam-medis.create') }}" class="btn btn-primary mb-3">
    Tambah Rekam Medis
</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.rekam-medis.edit', $d->idrekam_medis) }}" 
                       class="btn btn-sm btn-warning">
                        Edit
                    </a>

                    <form action="{{ route('admin.rekam-medis.destroy', $d->idrekam_medis) }}" 
